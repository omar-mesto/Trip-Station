...
import { createCountry, updateCountry, deleteCountry, getCountries, getLocalCountry, getInternationalCountry } from '../controllers/country.controller';
...
router.get('/local', protect, getLocalCountry);
router.get('/international', protect, getInternationalCountry);
